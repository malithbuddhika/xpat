...
# Cache expiration time in hours - cache entries older than this will be refreshed
CACHE_TTL_HOURS = 24
...
class CacheManager:
        ...
        if cached_time_str:
            try:
                ...
                if datetime.utcnow() > expiry_time:
                    logger.info("Cache expired for %s (cached at %s, TTL: %d hours)", key, cached_time_str, CACHE_TTL_HOURS)
                    return None
    ...
    def clear_cache(self) -> None:
        ...
        try:
            ...
            logger.warning("Failed to clear cache file: %s", exc)
